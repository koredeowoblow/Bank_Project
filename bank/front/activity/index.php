...
<body class=" layout-fixed  text-capitalize  layout-footer-fixed" style="background-color:honeydew;">
    ...
    <header class="navbar-light" style="background-image: linear-gradient(to bottom right,springgreen,forestgreen);">
        ...
        <div class="user-panel d-flex">
            <button class="btn btn-transparent" onclick="home()" style="color:white;"> <i class="fas fa-less-than w-70 p-2"></i></button>
            <h4 class="font-weight-bold my-3" style="font-size:2vmax,1.4vmin;text-align:start;">transfer activity</h4>
        </div>

        <!-- Right navbar links -->
    </header>
    <div class="container p-5 my-4" style="justify-self: center;margin-bottom:20%;">
        <div class="row" style="background-color:white;height:90px;width:800vmax,300vmin;" onclick="same()">
            ...
            <div class="col-7 col-sm-7  ">
                <p class="font-weight-bold my-2  mx-4" style="font-size:1.5vmax;text-align:start;">
                    add money
                </p>
            </div>
            <div class="col-2">
        ...
        <div class="row my-4 " style="background-color:white;">
            ...
            <div class="col-7 col-sm-7" onclick="trans()" >
                <p class="font-weight-bold my-3  mx-4" style="font-size:1.5vmax;text-align:start;">
                    transfer
                </p>
            </div>
            <div class="col-2">
