        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last" style="color:#607080;">
                    <h3 style="color:#607080;">all loan</h3>
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end" style="color:#607080;">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color:#607080;" aria-current="page">all loans</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    $(document).on('click', '#editbtn', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (json.status == 'due') {
                    previewModalBody += '<p style="color:red;font-size:20px;font-weight:900;text-align:center;"> loan due </p>'
